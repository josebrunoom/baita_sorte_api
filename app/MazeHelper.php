...
class MazeHelper
{
    ...
    /**
     * Converte uma planilha excel para um arranjo de arranjos ignorando as linhas cujo a primeira coluna é null
     */
    static public function converte_excel_para_arranjo($path)
    {
        try
        {
            ...
            foreach ($worksheet->getRowIterator() as $row) {
                ...
                foreach ($cellIterator as $cell) {
                    array_push($linha, $cell->getValue());
                }
/*                if($linha[0] == null){
                    continue;
                }*/
                array_push($planillha, $linha);
            }
